...
class InformasiUserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('informasiUser', compact('salaries'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('informasiUser.gaji')->with('success', 'Data gaji berhasil diperbarui');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('informasiUser.gaji')->with('success', 'Data gaji berhasil ditambahkan.');
    }
}
